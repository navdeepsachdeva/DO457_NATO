...
short_description: "Module to manage storage domain disk profiles in rhv"
author:
- "Niall O Donnell (@odonnelln)"
description:
    - "Module to manage storage domain disk profiles in rhv."
options:
    id:
        description:
    ...
    qos:
        description:
            - "Name of the QoS entry on the disk profile. If not passed defaults to rhv HE default"
        type: str
    state:
        description:
