...
---
module: ovirt_qos
short_description: "Module to manage QoS entries in rhv"
author:
- "Niall O Donnell (@odonnelln)"
description:
    - "Module to manage QoS entries in rhv."
...
qos:
    description: "Dictionary of all the QoS attributes. QoS attributes can be found on your rhv instance
